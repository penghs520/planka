---
name: planka-schema
description: 开发 planka 的 Schema 定义（实体类型、字段配置、视图、业务规则等）。当用户涉及 Schema 定义、实体类型继承、字段配置、视图定义、业务规则时激活。
---
...
| 实体类型 | CardTypeDefinition | 特征类型 / 实体类型 |
