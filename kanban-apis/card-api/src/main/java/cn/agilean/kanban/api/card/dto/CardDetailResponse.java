package cn.agilean.kanban.api.card.dto;

import cn.agilean.kanban.api.card.renderconfig.FieldRenderConfig;
import lombok.*;
...
public class CardDetailResponse {
    ...
    public static class FieldRenderMetaDTO {
        ...
        /** 是否在标签下方显示提示文本 */
        private Boolean showHintBelowLabel;
        /** 是否以 tooltip 形式显示提示 */
        private Boolean showHintAsTooltip;
    }
