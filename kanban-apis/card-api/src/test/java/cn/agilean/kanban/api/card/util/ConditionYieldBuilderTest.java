package cn.agilean.kanban.api.card.util;
...
class ConditionYieldBuilderTest {
    ...
    void shouldHandleLinkConditionItemReferenceValue() {
        ...
        LinkConditionItem.LinkSubject subject = new LinkConditionItem.LinkSubject(null, new cn.agilean.kanban.domain.link.LinkFieldId("link1:SOURCE"));
        ReferenceSource.Member member = new ReferenceSource.Member(null);
