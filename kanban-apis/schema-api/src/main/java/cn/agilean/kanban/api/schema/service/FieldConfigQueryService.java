...
import cn.agilean.kanban.api.schema.dto.inheritance.FieldSourceInfo;
...
public class FieldConfigQueryService {
    ...
    public List<FieldConfig> getFieldConfigs(String cardTypeId){
        Result<FieldConfigListWithSource> result = getFieldConfigListWithSource(cardTypeId);
