...
class FieldConfigQueryServiceTest {
    ...
    class GetFieldConfigsTests {
        ...
        void shouldReturnOwnConfigForAbstractCardType() {
            // Given
            cn.agilean.kanban.domain.schema.definition.cardtype.AbstractCardType abstractCardType =
                    new cn.agilean.kanban.domain.schema.definition.cardtype.AbstractCardType(
