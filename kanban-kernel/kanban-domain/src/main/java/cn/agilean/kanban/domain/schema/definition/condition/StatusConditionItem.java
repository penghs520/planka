...
public final class StatusConditionItem extends AbstractConditionItem {
    ...
    public interface StatusOperator {
        ...
        @Getter
        @JsonIgnoreProperties(ignoreUnknown = true)
        class NotEqual implements StatusOperator, NegativeOperator {
            private final String statusId;
        ...
        @Getter
        @JsonIgnoreProperties(ignoreUnknown = true)
        class NotIn implements StatusOperator, NegativeOperator {
            private final List<String> statusIds;
        ...
        @Getter
        @JsonIgnoreProperties(ignoreUnknown = true)
        class NotReached implements StatusOperator, NegativeOperator {
            private final String statusId;
