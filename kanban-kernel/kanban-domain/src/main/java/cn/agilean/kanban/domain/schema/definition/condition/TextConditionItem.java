...
public final class TextConditionItem extends AbstractConditionItem {
    ...
    public interface TextOperator {
        ...
        @Getter
        @JsonIgnoreProperties(ignoreUnknown = true)
        class NotEqual implements TextOperator, NegativeOperator {
            private final String value;
        ...
        @Getter
        @JsonIgnoreProperties(ignoreUnknown = true)
        class NotContains implements TextOperator, NegativeOperator {
            private final String value;
        ...
        /** 为空 */
        @JsonIgnoreProperties(ignoreUnknown = true)
        class IsEmpty implements TextOperator, NegativeOperator {
        }
