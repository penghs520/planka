...
import zgraph.driver.proto.model.CardList;
...
public class CardProtoConverter {
    ...
    public static CardDTO toCardDTO(Card protoCard) {
        ...
        // 状态信息
        dto.setCardCycle(QueryScopeConverter.fromProtoCardState(protoCard.getState()));
    ...
    public static Card toProtoCard(CreateCardRequest request, long cardId, long codeInOrg, String operatorId) {
        ...
        // 默认状态为 Active
        builder.setState(zgraph.driver.proto.common.CardState.Active);
    ...
    public static Card toProtoCard(CardEntity cardEntity) {
        ...
        builder.setState(QueryScopeConverter.toProtoCardState(cardEntity.getCardCycle()));
