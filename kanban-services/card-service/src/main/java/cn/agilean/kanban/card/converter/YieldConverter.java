...
import zgraph.driver.proto.query.YieldedField;
import zgraph.driver.proto.query.YieldedLink;
...
public class YieldConverter {
     ...
     * 转换为 protobuf Yield
     */
    public static zgraph.driver.proto.query.Yield toProto(Yield yield) {
        if (yield == null) {
            return zgraph.driver.proto.query.Yield.getDefaultInstance();
        }

        zgraph.driver.proto.query.Yield.Builder builder = zgraph.driver.proto.query.Yield.newBuilder();
     ...
     */
    public static String fromProtoPathNode(zgraph.driver.proto.common.PathNode pathNode) {
        if (pathNode == null) {
            return null;
        }
