...
import cn.agilean.kanban.event.card.CardAbandonedEvent;
import cn.agilean.kanban.event.card.CardArchivedEvent;
import cn.agilean.kanban.event.card.CardCreatedEvent;
import cn.agilean.kanban.event.card.CardEvent;
import cn.agilean.kanban.event.card.CardMovedEvent;
import cn.agilean.kanban.event.card.CardRestoredEvent;
...
public class CardEventPublisher {
    ...
    public void publishCreated(CardEntity cardEntity, String operatorId) {
        ...
        event.setCardCycle(cardEntity.getCardCycle());
