package cn.agilean.kanban.card.model;
...
public class CardEntity {
    ...
    public CardEntity(CardId id, long codeInOrg, String customCode, OrgId orgId, CardTypeId typeId, CardTitle title, CardCycle cardCycle,
