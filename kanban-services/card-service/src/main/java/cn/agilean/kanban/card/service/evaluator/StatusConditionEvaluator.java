...
import cn.agilean.kanban.domain.schema.definition.condition.StatusConditionItem;
...
public class StatusConditionEvaluator extends AbstractConditionEvaluator {
     ...
     * 评估单个卡片
     */
    private boolean evaluateSingleCard(StatusConditionItem item, CardDTO card) {
        var subject = item.getSubject();
        var operator = item.getOperator();
