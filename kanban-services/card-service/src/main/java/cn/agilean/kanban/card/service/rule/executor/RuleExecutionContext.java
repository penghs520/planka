...
public class RuleExecutionContext {
     ...
     * 创建静态工厂方法
     */
    public static RuleExecutionContext build(CardDTO triggerCard, CardDTO operatorCard,
                                             BizRuleDefinition.TriggerEvent event) {
        return RuleExecutionContext.builder()
                .triggerCard(triggerCard)
                .cardId(triggerCard.getId())
                .cardTypeId(triggerCard.getTypeId())
                .operatorCard(operatorCard)
                .orgId(triggerCard.getOrgId() != null ? triggerCard.getOrgId().value() : null)
                .triggerEvent(event)
                .build();
    }
}
