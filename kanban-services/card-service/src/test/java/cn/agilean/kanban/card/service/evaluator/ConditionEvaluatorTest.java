...
import cn.agilean.kanban.domain.schema.definition.condition.TextConditionItem.TextOperator;
import cn.agilean.kanban.domain.schema.definition.condition.TextConditionItem.TextSubject;
...
class ConditionEvaluatorTest {
    ...
    @Mock
    private TitleConditionEvaluator titleEvaluator;
    @Mock
    private CodeConditionEvaluator codeEvaluator;
    @Mock
    private WebUrlConditionEvaluator webUrlEvaluator;
    @Mock
    private KeywordConditionEvaluator keywordEvaluator;
    ...
    class EmptyConditionTests {
        ...
        void evaluate_returnsTrue_whenConditionIsNull() {
            ...
            boolean result = evaluator.evaluate(null, card, null);
