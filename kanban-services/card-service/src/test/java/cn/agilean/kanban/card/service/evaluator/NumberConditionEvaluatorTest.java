...
import cn.agilean.kanban.domain.schema.definition.condition.NumberConditionItem;
import cn.agilean.kanban.domain.schema.definition.condition.NumberConditionItem.NumberOperator;
import cn.agilean.kanban.domain.schema.definition.condition.NumberConditionItem.NumberSubject;
import cn.agilean.kanban.domain.schema.definition.condition.NumberConditionItem.NumberValue;
...
class NumberConditionEvaluatorTest {
    ...
    class EqualTests {
        ...
        void evaluate_returnsTrue_whenActualEqualsExpected() {
            ...
            setFieldValue(card, "points", new NumberFieldValue("points", 10.0));
        ...
        void evaluate_returnsFalse_whenActualNotEqualsExpected() {
            ...
            NumberConditionItem condition = createCondition("points",
                new NumberOperator.Equal(staticValue(10.0)));
            setFieldValue(card, "points", new NumberFieldValue("points", 5.0));
    ...
    class BetweenTests {
        ...
        void evaluate_returnsTrue_whenActualEqualsUpperBound() {
            ...
            NumberConditionItem condition = createCondition("points",
                new NumberOperator.Between(staticValue(5.0), staticValue(15.0)));
            setFieldValue(card, "points", new NumberFieldValue("points", 15.0));
        ...
        void evaluate_returnsFalse_whenActualBelowLowerBound() {
            ...
            NumberConditionItem condition = createCondition("points",
                new NumberOperator.Between(staticValue(5.0), staticValue(15.0)));
            setFieldValue(card, "points", new NumberFieldValue("points", 3.0));
        ...
        void evaluate_returnsFalse_whenActualAboveUpperBound() {
            ...
            NumberConditionItem condition = createCondition("points",
                new NumberOperator.Between(staticValue(5.0), staticValue(15.0)));
            setFieldValue(card, "points", new NumberFieldValue("points", 20.0));
