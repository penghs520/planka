package cn.agilean.kanban.card.service.rule.executor;
...
import cn.agilean.kanban.domain.schema.definition.rule.RetryConfig;
import cn.agilean.kanban.domain.schema.definition.rule.RuleExecutionLog;
...
import cn.agilean.kanban.domain.schema.definition.rule.action.RuleAction;
...
class BizRuleExecutionServiceTest {
    ...
    class BasicExecutionTests {
        ...
        void shouldSkip_whenConditionNotMet() {
            ...
            when(conditionEvaluator.evaluate(eq(condition), any(CardDTO.class), any(CardDTO.class))).thenReturn(false);
