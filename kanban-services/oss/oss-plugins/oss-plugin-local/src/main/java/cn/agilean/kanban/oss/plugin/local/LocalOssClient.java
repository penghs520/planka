package cn.agilean.kanban.oss.plugin.local;

import cn.agilean.kanban.oss.plugin.FileCategory;
import cn.agilean.kanban.oss.plugin.OssClient;
import cn.agilean.kanban.oss.plugin.UploadRequest;
import cn.agilean.kanban.oss.plugin.UploadResult;
