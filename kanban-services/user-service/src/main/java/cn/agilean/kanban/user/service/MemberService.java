package cn.agilean.kanban.user.service;
...
import cn.agilean.kanban.api.user.dto.MemberDTO;
import cn.agilean.kanban.api.user.dto.MemberOptionDTO;
import cn.agilean.kanban.api.user.enums.OrganizationRole;
import cn.agilean.kanban.api.user.enums.UserStatus;
import cn.agilean.kanban.api.user.request.AddMemberRequest;
import cn.agilean.kanban.api.user.request.UpdateMemberRoleRequest;
...
import cn.agilean.kanban.infra.cache.schema.query.CardTypeCacheQuery;
import cn.agilean.kanban.user.model.OrganizationEntity;
import cn.agilean.kanban.user.model.UserEntity;
import cn.agilean.kanban.user.model.UserOrganizationEntity;
import cn.agilean.kanban.user.repository.OrganizationRepository;
import cn.agilean.kanban.user.repository.UserOrganizationRepository;
import cn.agilean.kanban.user.repository.UserRepository;
import cn.agilean.kanban.user.security.PasswordEncoder;
...
public class MemberService {
    ...
    private CardPageQueryRequest buildMemberOptionsQueryRequest(
        ...
        cn.agilean.kanban.api.card.request.Page pageParam = new cn.agilean.kanban.api.card.request.Page();
