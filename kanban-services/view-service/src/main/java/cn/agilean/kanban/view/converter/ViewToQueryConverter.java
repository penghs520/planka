package cn.agilean.kanban.view.converter;

import cn.agilean.kanban.api.card.request.*;
import cn.agilean.kanban.api.view.request.UserSortField;
import cn.agilean.kanban.api.view.request.ViewDataRequest;
import cn.agilean.kanban.common.page.SortDirection;
...
public class ViewToQueryConverter {
    ...
    private List<Sort> convertViewSorts(List<cn.agilean.kanban.common.page.SortField> viewSorts) {
        return viewSorts.stream()
                .map(this::convertViewSort)
                .collect(Collectors.toList());
    }

    private Sort convertViewSort(cn.agilean.kanban.common.page.SortField viewSort) {
        Sort sort = new Sort();
