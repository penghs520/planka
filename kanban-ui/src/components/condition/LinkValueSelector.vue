...
.link-value-trigger {
  ...
  .selected-cards {
    ...
    /* 关闭按钮默认隐藏，hover时显示 */
    :deep(.arco-tag .arco-tag-close-btn) {
      display: none;
      margin-left: 4px;
      width: 12px;
      height: 12px;
    ...
    :deep(.arco-tag:hover .arco-tag-close-btn) {
      display: inline-flex;
    }

    /* 关闭图标 */
    :deep(.arco-tag .arco-icon-close) {
      font-size: 8px;
      color: #fff !important;
    ...
    :deep(.arco-tag .arco-icon-close:hover) {
      background: none !important;
      color: #fff !important;
    }

    /* 关闭按钮hover效果 */
    :deep(.arco-tag .arco-tag-close-btn:hover) {
      background-color: #6a9ec4 !important;
    }

    /* 移除图标hover高亮效果 */
    :deep(.arco-tag .arco-tag-close-btn.arco-icon-hover::before),
    :deep(.arco-tag .arco-tag-close-btn.arco-icon-hover:hover::before) {
