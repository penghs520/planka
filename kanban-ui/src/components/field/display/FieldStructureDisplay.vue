...
const formattedValue = computed(() => formatStructureValue(props.value as { id?: string; name?: string; next?: unknown }))
...
<template>
  <span :class="['field-structure-display', { 'is-empty': isEmpty }]">{{ displayValue }}</span>
</template>
