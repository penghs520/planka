...
import cn.planka.domain.schema.definition.action.assignment.DateValue;
import cn.planka.domain.schema.definition.action.assignment.EnumValue;
import cn.planka.domain.schema.definition.action.assignment.FieldAssignment;
import cn.planka.domain.schema.definition.action.assignment.FixedValue;
import cn.planka.domain.schema.definition.action.assignment.FixedValueAssignment;
import cn.planka.domain.schema.definition.action.assignment.NumberValue;
import cn.planka.domain.schema.definition.action.assignment.TextValue;
import cn.planka.domain.schema.definition.rule.action.CreateLinkedCardAction;
