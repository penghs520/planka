package cn.planka.schema.service;
...
import cn.planka.schema.service.linktype.LinkTypeService;
...
class LinkTypeServiceTest {
    ...
    class CreateLinkTypeTests {
        ...
        void shouldCreateLinkTypeSuccessfully() {
            ...
            request.setSourceCardTypeId("ct-src");
            request.setTargetCardTypeId("ct-tgt");
    ...
    class GetAvailableLinkTypesTests {
        ...
        void shouldFilterBySourcePosition() {
            ...
            linkType.setSourceCardTypeId(CardTypeId.of("ct-1"));
            linkType.setTargetCardTypeId(CardTypeId.of("ct-2"));
