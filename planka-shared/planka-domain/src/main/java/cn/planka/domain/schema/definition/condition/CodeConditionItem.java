...
public final class CodeConditionItem extends AbstractConditionItem {
    ...
    @JsonSubTypes({
            @JsonSubTypes.Type(value = CodeOperator.Equal.class, name = "EQ"),
            @JsonSubTypes.Type(value = CodeOperator.NotEqual.class, name = "NE"),
            @JsonSubTypes.Type(value = CodeOperator.Contains.class, name = "CONTAINS"),
            @JsonSubTypes.Type(value = CodeOperator.NotContains.class, name = "NOT_CONTAINS"),
    })
    public interface CodeOperator {
        ...
        @Getter
        @JsonIgnoreProperties(ignoreUnknown = true)
        class NotEqual implements CodeOperator, NegativeOperator {
            private final String value;
        ...
        @Getter
        @JsonIgnoreProperties(ignoreUnknown = true)
        class NotContains implements CodeOperator, NegativeOperator {
            private final String value;
