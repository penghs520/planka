...
public final class EnumConditionItem extends AbstractConditionItem {
    ...
    public interface EnumOperator {
        ...
        @Getter
        @JsonIgnoreProperties(ignoreUnknown = true)
        class NotEqual implements EnumOperator, NegativeOperator {
            private final String optionId;
        ...
        @Getter
        @JsonIgnoreProperties(ignoreUnknown = true)
        class NotIn implements EnumOperator, NegativeOperator {
            private final List<String> optionIds;
        ...
        /** 为空 */
        @JsonIgnoreProperties(ignoreUnknown = true)
        class IsEmpty implements EnumOperator, NegativeOperator {
        }
