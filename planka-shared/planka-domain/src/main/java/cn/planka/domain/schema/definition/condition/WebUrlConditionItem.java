...
public final class WebUrlConditionItem extends AbstractConditionItem {
    ...
    public interface WebUrlOperator {
        ...
        @Getter
        @JsonIgnoreProperties(ignoreUnknown = true)
        class NotEqual implements WebUrlOperator, NegativeOperator {
            private final String url;
        ...
        @Getter
        @JsonIgnoreProperties(ignoreUnknown = true)
        class NotContains implements WebUrlOperator, NegativeOperator {
            private final String value;
        ...
        /** 为空 */
        @JsonIgnoreProperties(ignoreUnknown = true)
        class IsEmpty implements WebUrlOperator, NegativeOperator {
        }
