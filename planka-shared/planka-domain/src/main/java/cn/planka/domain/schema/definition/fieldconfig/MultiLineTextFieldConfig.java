...
/**
 * 多行文本属性的__PLANKA_EINST__级别配置
 */
@Getter
@Setter
@JsonIgnoreProperties(ignoreUnknown = true)
public final class MultiLineTextFieldConfig extends FieldConfig {

    @Override
    public String getSchemaSubType() {
        return SchemaSubType.MULTI_LINE_TEXT_FIELD;
    }
    ...
    @JsonCreator
    public MultiLineTextFieldConfig(
