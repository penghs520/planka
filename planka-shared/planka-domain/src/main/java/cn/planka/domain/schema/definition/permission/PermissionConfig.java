package cn.planka.domain.schema.definition.permission;
 ...
 * 权限定义
 * <p>
 * 定义实体类型级别的权限配置，包括操作权限、属性权限、附件权限等。
 */
@Setter
@Getter
...
public final class PermissionConfig {
    ...
    public static class FieldPermission {
         ...
         */
        @JsonProperty("operations")
        private List<FieldOperation> operations;
    ...
    public static class AttachmentPermission {
         ...
         * 附件操作类型
         */
        @JsonProperty("attachmentOperations")
        private List<AttachmentOperation> attachmentOperations;
