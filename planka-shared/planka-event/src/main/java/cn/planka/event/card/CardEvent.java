package cn.planka.event.card;

import cn.planka.domain.history.OperationSource;
import cn.planka.domain.history.source.UserOperationSource;
import cn.planka.event.DomainEvent;
...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = CardMigrationRequestedEvent.class, name = "card.migration.requested")
})
