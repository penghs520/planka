...
export default {
  ...
  route: {
    ...
    linkTypeList: 'Entity Relation List',
    linkTypeGraph: 'Entity Relation Graph',
  ...
  org: {
    ...
    status: 'Status',
    statusActive: 'Active',
    switchedInOtherTab: 'Organization Switched',
    switchConfirmMessage: 'You switched to organization "{name}" in another tab. Please refresh to continue.',
    switchConfirmButton: 'Refresh Now',
  },
  ...
  schemaTypeName: {
    ...
    STRUCTURE_DEFINITION: 'Structure Line',
    CARD_CREATE_PAGE_TEMPLATE: 'Create Page Template',
    NOTIFICATION_CHANNEL_CONFIG: 'Notification Channel Config',
