...
export default {
  ...
  org: {
    ...
    status: '状态',
    statusActive: '正常',
    switchedInOtherTab: '组织已切换',
    switchConfirmMessage: '您在另一个标签页中切换到了组织「{name}」，请刷新以继续访问',
    switchConfirmButton: '立即刷新',
  },
  ...
  schemaTypeName: {
    ...
    STRUCTURE_DEFINITION: '架构线定义',
    CARD_CREATE_PAGE_TEMPLATE: '新建页模板',
    NOTIFICATION_CHANNEL_CONFIG: '通知渠道配置',
    CARD_ACTION: '卡片动作',
    notSupported: 'Schema类型 {type} 不支持跳转',
