...
const columnClass = computed(() => {
  return props.step.id === null ? 'step-column step-column-new' : 'step-column'
})
...
<template>
  <div :class="columnClass" :style="columnStyle">
    <!-- 阶段头部 -->
    <div
      class="step-header"
      :style="headerStyle"
    ...
    >
      ...
      <div class="step-actions">
        <a-popconfirm
          :content="t('admin.cardType.valueStream.confirmDeleteStep')"
          @ok="handleDeleteStep"
        >
