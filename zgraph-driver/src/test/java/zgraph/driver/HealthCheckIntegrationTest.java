...
import zgraph.driver.proto.auth.AuthResponse;
...
class HealthCheckIntegrationTest {
    ...
    void testMultipleClientConnections() throws Exception {
        ...
        ZgraphClientConfig config2 = ZgraphClientConfig.builder()
                ...
                .password("test2")
                .build();
        ZgraphClient client2 = new ZgraphClient(config2);
        Thread.sleep(500);
    ...
    private void sendTestRequestWithClient(ZgraphClient testClient) throws Exception {
