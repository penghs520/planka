...
import zgraph.driver.config.ZgraphClientConfig.LoadBalanceStrategy;
...
public class HealthCheckTest {
        ...
        void testClientWithMixedHealthyUnhealthyServers() throws Exception {
                ...
                ZgraphCardQueryClient queryClient = new ZgraphCardQueryClient(client);
                ...
                try {
                        // 创建一个简单的查询请求
                        zgraph.driver.proto.query.QueryContext queryContext = zgraph.driver.proto.query.QueryContext
                                        .newBuilder()
                                        .setOrgId("test-org")
                                        .build();

                        zgraph.driver.proto.query.QueryScope queryScope = zgraph.driver.proto.query.QueryScope
                                        .newBuilder()
                                        .addCardIds(1L)
                                        .build();

                        zgraph.driver.proto.query.CardQueryRequest request = zgraph.driver.proto.query.CardQueryRequest
                                        .newBuilder()
                        ...
                        // 发送请求
                        java.util.concurrent.CompletableFuture<zgraph.driver.proto.query.CardQueryResponse> future = queryClient
                                        .query(request);

                        try {
                                // 设置较短的超时时间
                                zgraph.driver.proto.query.CardQueryResponse response = future.get(10,
