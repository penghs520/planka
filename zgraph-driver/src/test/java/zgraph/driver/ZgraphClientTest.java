...
import zgraph.driver.exception.RequestIdMismatchException;
...
public class ZgraphClientTest {

        private static final Logger logger = LoggerFactory.getLogger(ZgraphClientTest.class);

        private ZgraphClient client;
        ...
        void setUp() {
                ...
                client = new ZgraphClient(config);
        }
        ...
        void testClientCreationWithDefaultConfig() {
                ZgraphClient defaultClient = new ZgraphClient();
        ...
        public void testCardQuery() throws ExecutionException, InterruptedException {
                ...
                // 创建客户端并发送请求
                ZgraphCardQueryClient zgraphCardQueryClient = new ZgraphCardQueryClient(client);
                ...
                // 发送请求并获取结果
                CompletableFuture<CardQueryResponse> future = zgraphCardQueryClient.query(request);
        ...
        public void testCardCount() throws Exception {
                ...
                // 发送计数请求
                CompletableFuture<Integer> future = zgraphCardQueryClient.countCards(request);
        ...
        public void testConnectionIdleRelease() throws Exception {
                ...
                CompletableFuture<CardQueryResponse> future1 = zgraphCardQueryClient.query(request);
                ...
                CompletableFuture<CardQueryResponse> future2 = zgraphCardQueryClient.query(request);
                ...
                for (int i = 0; i < concurrentRequestCount; i++) {
                        futures.add(zgraphCardQueryClient.query(request));
                }
