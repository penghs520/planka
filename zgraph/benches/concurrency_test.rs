...
use zgraph::proto::{request::RequestType, Request, Response};
use zgraph::server::start_server;
...
async fn start_test_server(db: Arc<RocksDatabase>, config: TestConfig) -> Result<()> {
    ...
    let db_config = zgraph::database::rdb::rdb_config::RocksDbConfig::default();
