...
#[get("/cluster/init")]
pub async fn init(app: Data<ZgraphRaftApp>) -> actix_web::Result<impl Responder> {
...
#[get("/cluster/metrics")]
pub async fn metrics(app: Data<ZgraphRaftApp>) -> actix_web::Result<impl Responder> {
...
pub async fn trigger_snapshot(app: Data<ZgraphRaftApp>) -> actix_web::Result<impl Responder> {
