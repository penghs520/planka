...
pub enum Request {
    // 批量创建卡片请求
    BatchCreateCards {
        request: crate::proto::zgraph::write::BatchCreateCardRequest,
    },
    // 批量更新卡片请求
    BatchUpdateCards {
        request: crate::proto::zgraph::write::BatchUpdateCardRequest,
    },
    // 批量更新卡片标题请求
    BatchUpdateCardTitles {
        request: crate::proto::zgraph::write::BatchUpdateCardTitleRequest,
    },
    // 批量部分更新卡片属性请求
    BatchUpdateCardField {
        request: crate::proto::zgraph::write::BatchUpdateCardFieldRequest,
    },
    // 批量创建关联关系请求
    BatchCreateLinks {
        request: crate::proto::zgraph::write::BatchCreateLinkRequest,
    },
    // 批量更新关联关系请求
    BatchUpdateLinks {
        request: crate::proto::zgraph::write::BatchUpdateLinkRequest,
    },
    // 批量删除关联关系请求
    BatchDeleteLinks {
        request: crate::proto::zgraph::write::BatchDeleteLinkRequest,
    },
}
