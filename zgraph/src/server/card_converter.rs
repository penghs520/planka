...
use crate::proto::zgraph::model::{Card, CardList};
...
pub fn convert_to_cards<'a, T: Transaction<'a>>(
    vertices: &[Arc<Vertex>],
    txn: &T,
    r#yield: Option<&crate::proto::zgraph::query::Yield>,
) -> Vec<Card> {
    // 检查是否需要包含卡片描述
    ...
    if let Ok(neighbor_vertices) = txn.query_neighbor_vertices(&query) {
        ...
        for neighbor in &neighbor_vertices {
            ...
            let r#yield = if let Some(yf) = yielded_field {
                crate::proto::zgraph::query::Yield {
...
) -> Option<crate::proto::zgraph::field::FieldValue> {
    use crate::proto::zgraph::field::field_value::FieldType;
    use crate::proto::zgraph::field::*;
...
pub fn vertex_title_to_proto_title(vertex_title: &VertexTitle) -> crate::proto::zgraph::model::Title {
    use crate::proto::zgraph::common::TitleJointArea;
    use crate::proto::zgraph::model::{
...
pub fn vertex_to_card_with_yield(
    ...
    let proto_state = match vertex.state {
        CardState::Active => crate::proto::zgraph::common::CardState::Active as i32,
        CardState::Archived => crate::proto::zgraph::common::CardState::Archived as i32,
        CardState::Discarded => crate::proto::zgraph::common::CardState::Discarded as i32,
    };
