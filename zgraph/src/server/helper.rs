...
use crate::proto::zgraph::query::{self, condition_node::NodeType};
...
fn reverse_path(path: &crate::proto::zgraph::common::Path) -> crate::proto::zgraph::common::Path {
    let mut reversed_path = crate::proto::zgraph::common::Path {
...
mod tests {
    ...
    fn test_reverse_path() {
        let original_path = crate::proto::zgraph::common::Path {
            nodes: vec![
                crate::proto::zgraph::common::PathNode {
