...
async fn handle_update_log_level_request(
    ...
    // 创建日志级别更新响应
    let update_log_level_response = crate::proto::zgraph::admin::UpdateLogLevelResponse {
        success,
...
async fn handle_database_stats_request(
    ...
    // 构建protobuf响应
    let stats_response = crate::proto::zgraph::admin::DatabaseStatsResponse {
        ...
        cache_stats: Some(crate::proto::zgraph::admin::CacheStats {
