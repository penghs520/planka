...
mod tests {
    ...
    use crate::proto::zgraph::common::{Path, PathNode};
    use crate::proto::zgraph::query::{
                ...
                node_type: Some(NodeType::EnumItem(EnumConditionItem {
                    ...
                    operator: Some(EnumOperator {
                        operator_type: Some(enum_operator::OperatorType::Equal(
                            EnumEqualOperator {
                                value_type: Some(crate::proto::zgraph::query::enum_equal_operator::ValueType::StaticValues(
                ...
                node_type: Some(NodeType::Date(DateConditionItem {
                    ...
                    operator: Some(DateOperator {
                        operator_type: Some(date_operator::OperatorType::After(
                            DateAfterOperator {
                                value_type: Some(crate::proto::zgraph::query::date_after_operator::ValueType::StaticValue(1645000000000)),
                            }
                        )),
                    }),
                ...
                node_type: Some(NodeType::Link(LinkConditionItem {
                    ...
                    operator: Some(LinkOperator {
                        operator_type: Some(link_operator::OperatorType::Equal(
                            LinkEqualOperator {
                                value: Some(crate::proto::zgraph::query::link_equal_operator::Value::SpecialLink(
                                    SpecialLink {
                                        card_ids: vec![2],
