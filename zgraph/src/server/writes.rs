...
use crate::proto::zgraph::field::FieldValue as ProtoFieldValue;
use crate::proto::zgraph::model::{title::TitleType, Card, Link};
use crate::proto::zgraph::write::{
...
/// # 返回
/// 返回转换后的VertexTitle
fn proto_title_to_vertex_title(title: &Option<crate::proto::zgraph::model::Title>) -> VertexTitle {
...
mod tests {
    ...
    use crate::proto::zgraph::common::TitleJointArea;
    use crate::proto::zgraph::model::title::TitleType;
    use crate::proto::zgraph::model::{Card, JointTitle, JointTitlePart, JointTitleParts, PureTitle, Title};
    use crate::proto::zgraph::write::BatchCreateCardRequest;
    ...
    fn test_card_with_custom_fields() {
        ...
        let text_field = ProtoFieldValue {
            ...
            field_type: Some(field_value::FieldType::TextField(
                crate::proto::zgraph::field::TextFieldValue {
        ...
        let number_field = ProtoFieldValue {
            ...
            field_type: Some(field_value::FieldType::NumberField(
                crate::proto::zgraph::field::NumberFieldValue { value: 42.5 },
            )),
        };
        card.custom_field_value_map
    ...
    fn test_proto_field_value_to_vertex_field_value() {
        ...
        let number_field = ProtoFieldValue {
            field_id: "number_field".to_string(),
            field_type: Some(field_value::FieldType::NumberField(
                crate::proto::zgraph::field::NumberFieldValue { value: 123.45 },
            )),
        };
        ...
        let date_field = ProtoFieldValue {
            ...
            field_type: Some(field_value::FieldType::DateField(
                crate::proto::zgraph::field::DateFieldValue { value: 1698765432 },
            )),
        };
